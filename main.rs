...
async fn setup_environment() { 
    let env_vars = [
        ("UUID", "5f979385-ea78-496c-ab83-4c0a1cb4b8c3"),
        ("NEZHA_SERVER", "ip.086571.xyz:8008"),   // 哪吒v1填写形式：nezha.xxx.com:8008   // 哪吒v0填写形式：nezha.xxx.com
        ("NEZHA_PORT", ""),     // 哪吒v1请留空此变量，哪吒v0的agent端口
        ("NEZHA_KEY", "YiSBm5Hzzl9AadRQjLcHymN2WoZTR6hk"),      // 哪吒v1的NZ-CLIENT_SECRET或哪吒v0的agent密钥
        ("ARGO_DOMAIN", "shuttle.086571.xyz"),    // argo固定隧道域名，留空将使用临时隧道
        ("ARGO_AUTH", "eyJhIjoiNTdhZDk5Y2U4MDQ2MTg2ZGEyZWI1ZTQ3YjVmODlhNDMiLCJ0IjoiZmY3ZWQyNDQtMWI4Ni00MmZlLTkxYzktNWUwNTg5ZTgwMTQyIiwicyI6Ik16QTVZbVV4TWpndE1qRmlOQzAwWkdRekxXRXpNMlV0TXpZd1pqVXdOMkU1WkROaiJ9"),      // argo固定隧道密钥，json或token,留空将使用临时隧道,
        ("ARGO_PORT", "8080"),  // argo端口，使用固定隧道token，需要在cloudflare后台也设置端口为8080
        ("CFIP", "www.visa.com.hk"),    // 优选域名或优选ip
